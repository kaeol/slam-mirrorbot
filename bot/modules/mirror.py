...
def _mirror(bot, update, isTar=False, extract=False):
    ...
    if not bot_utils.is_url(link) and not bot_utils.is_magnet(link):
        bot.send_message(update.message.chat_id, text='<b>Opps 🤦! Not Like That</b>\n\nCheck 👉 <a href="https://telegra.ph/HOW-TO-MIRROR-06-08"> 𝐇𝐎𝐖 𝐓𝐎 𝐌𝐈𝐑𝐑𝐎𝐑?</a>',disable_web_page_preview=True, reply_to_message_id=update.message.reply_to_message.message_id, parse_mode='HTMl')
        return 
    try:
