...
class MirrorStatus:
    ...
    STATUS_DOWNLOADING = "<b>Mirroring..📥</b>"
    STATUS_WAITING = "<b>Queued...⌛</b>"
    STATUS_FAILED = "<b>Failed 🚫. Cleaning Download...</b>"
    STATUS_CANCELLED = "<b>Cancelled ❌. Cleaning Download...</b>"
        ...
        for download in list(download_dict.values()):
            ...
            if download.status() != MirrorStatus.STATUS_ARCHIVING and download.status() != MirrorStatus.STATUS_EXTRACTING:
                ...
                try:
                    ...
                    pass
                msg += f'\n<b>Mirror By:</b> <a href="tg://user?id={download.message.from_user.id}">{download.message.from_user.first_name}</a> (<code>{download.message.from_user.id}</code>)'
